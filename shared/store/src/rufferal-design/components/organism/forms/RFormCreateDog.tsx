...
export const RFormCreateDog = ({
  ...
  return (
    <View style={tw`gap-${moderateScaleTW(8)}`}>
      ...
      <View>
        <RLabel label="Age" />
        <RFormToggle label="Puppy (0–9 months)" />
      ...
      <View>
        <RLabel label="Size" />
        <RFormToggle label="Small (0–25 lbs)" />
        <RFormToggle label="Medium (26–60 lbs)" />
        <RFormToggle label="Large (61–100 lbs)" />
        <RFormToggle label="Extra large (101+ lbs)" />
      </View>
      <View>
        <RLabel label="Sex" />
